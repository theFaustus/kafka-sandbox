 ...
 */
package evil.inc.kafkasandbox.payload.avro;
...
public class Customer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static evil.inc.kafkasandbox.payload.avro.Customer.Builder newBuilder() {
    return new evil.inc.kafkasandbox.payload.avro.Customer.Builder();
  }
   ...
   * @return A new Customer RecordBuilder
   */
  public static evil.inc.kafkasandbox.payload.avro.Customer.Builder newBuilder(evil.inc.kafkasandbox.payload.avro.Customer.Builder other) {
    if (other == null) {
      return new evil.inc.kafkasandbox.payload.avro.Customer.Builder();
    } else {
      return new evil.inc.kafkasandbox.payload.avro.Customer.Builder(other);
    }
  }
   ...
   * @return A new Customer RecordBuilder
   */
  public static evil.inc.kafkasandbox.payload.avro.Customer.Builder newBuilder(evil.inc.kafkasandbox.payload.avro.Customer other) {
    if (other == null) {
      return new evil.inc.kafkasandbox.payload.avro.Customer.Builder();
    } else {
      return new evil.inc.kafkasandbox.payload.avro.Customer.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Customer>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(evil.inc.kafkasandbox.payload.avro.Customer.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(evil.inc.kafkasandbox.payload.avro.Customer other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public evil.inc.kafkasandbox.payload.avro.Customer.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public evil.inc.kafkasandbox.payload.avro.Customer.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public evil.inc.kafkasandbox.payload.avro.Customer.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public evil.inc.kafkasandbox.payload.avro.Customer.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public evil.inc.kafkasandbox.payload.avro.Customer.Builder setFaxNumber(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public evil.inc.kafkasandbox.payload.avro.Customer.Builder clearFaxNumber() {
      faxNumber = null;
