...
@Slf4j
public class KafkaConsumerManualAsyncWithRebalanceCommit {
    public static void main(String[] args) {
        Properties kafkaProps = new Properties();
        kafkaProps.put(BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        kafkaProps.put(GROUP_ID_CONFIG, "KafkaConsumerManualAsyncWithRebalanceCommitGroup-4");
        kafkaProps.put(CLIENT_ID_CONFIG, "KafkaConsumerManualAsyncWithRebalanceCommitClient-1");
        ...
        try (KafkaConsumer<String, String> consumer = new KafkaConsumer<>(kafkaProps)) {
            ...
            while (true) {
                ...
                consumerRecords.forEach(record -> {
                    ...
                    if (count.get() % 7 == 0) {
                        //trigger a consumer shutdown, therefore a rebalance with lost partitions
                        throw new RuntimeException("This is gonna hurt like a m!@#$%cker");
                    }
