...
public class KafkaConsumerJson {
    public static void main(String[] args) {
        ...
        kafkaProps.put(GROUP_ID_CONFIG, "KafkaConsumerJson-5");
        kafkaProps.put(CLIENT_ID_CONFIG, "KafkaConsumerJson-1");
        ...
        try (KafkaConsumer<String, Customer> consumer = new KafkaConsumer<>(kafkaProps)) {
            ...
            consumer.subscribe(List.of("CustomersJson"), new ConsumerRebalanceListener() {
                @Override
