...
@Slf4j
public class KafkaConsumerManualSyncAsyncCommit {
    public static void main(String[] args) {
        Properties kafkaProps = new Properties();
        kafkaProps.put(BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        kafkaProps.put(GROUP_ID_CONFIG, "KafkaConsumerManualSyncAsyncCommitGroup-1");
        kafkaProps.put(CLIENT_ID_CONFIG, "KafkaConsumerManualSyncAsyncCommitClient-1");
