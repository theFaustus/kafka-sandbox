...
@Slf4j
public class KafkaConsumerManualAsyncAtOffsetCommit {
    public static void main(String[] args) {
        Properties kafkaProps = new Properties();
        kafkaProps.put(BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        kafkaProps.put(GROUP_ID_CONFIG, "KafkaConsumerManualAsyncAtOffsetCommitGroup-2");
        kafkaProps.put(CLIENT_ID_CONFIG, "KafkaConsumerManualAsyncAtOffsetCommitClient-1");
