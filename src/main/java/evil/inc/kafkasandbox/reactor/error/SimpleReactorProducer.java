package evil.inc.kafkasandbox.reactor.error;
...
public class SimpleReactorProducer {
    ...
    private static SenderRecord<String, String, String> createSenderRecord(Integer i) {
        ...
        ProducerRecord<String, String> producerRecord = new ProducerRecord<>("error-test-topic", null, i.toString(), "order-" + i, headers);
